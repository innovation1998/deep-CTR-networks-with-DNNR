...
from deepctr_torch.layers import DNN, CIN, BiInteractionPooling, FM

from dnnr import DNNR

class xDeepFMR(BaseModel):
    def __init__(self, linear_feature_columns, dnn_feature_columns, dnn_hidden_units=(256, 256), use_shortcut=True,
        ...
        super(xDeepFMR, self).__init__(linear_feature_columns, dnn_feature_columns, l2_reg_linear=l2_reg_linear,
