...
from deepctr_torch.layers import CrossNetMix, CrossNet, DNN, BiInteractionPooling, FM
from deepctr_torch.inputs import combined_dnn_input
from dnnr import DNNR


class DCNMixR(BaseModel):
    def __init__(self, linear_feature_columns,
                 ...
                 dnn_dropout=0, low_rank=32, num_experts=4, use_shortcut=True,
                 dnn_activation='relu', dnn_use_bn=False, task='binary', device='cpu'):

        super(DCNMixR, self).__init__(linear_feature_columns=linear_feature_columns,
